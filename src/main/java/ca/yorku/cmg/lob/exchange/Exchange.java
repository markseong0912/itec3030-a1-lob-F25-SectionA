...
public class Exchange {
	...
	public void submitOrder(IOrder o, long time) {
		...
		for (ITrade t:oOutcome.getResultingTrades()) {
			...
			accounts.getTraderAccount(accounts.getTraderByID(t.getBuyerID())).applyFee(t);
			//Apply the trade payment to the account balance of the buyer (they spent money)
			accounts.getTraderAccount(accounts.getTraderByID(t.getBuyerID())).withdrawMoney(t.getValue());
			//Add the bought stocks to the position of the buyer
			accounts.getTraderAccount(accounts.getTraderByID(t.getBuyerID())).addToPosition(t.getTkr(), t.getQuantity());
			...
			accounts.getTraderAccount(accounts.getTraderByID(t.getSellerID())).applyFee(t);
			//Apply the trade payment to the account balance of the seller (they earned money)
			accounts.getTraderAccount(accounts.getTraderByID(t.getSellerID())).addMoney(t.getValue());
			//Deduct the sold stocks from the position of the seller
			accounts.getTraderAccount(accounts.getTraderByID(t.getSellerID())).deductFromPosition(t.getTkr(), t.getQuantity());
